...
public class Rank11Activity extends Activity {
	...
	public void set(){
		...
		button8.setBackground(getResources().getDrawable(R.drawable.purplebutton));
		button9.setBackground(getResources().getDrawable(R.drawable.purplebutton));
	...
	protected void actionAlertDialog(){
        ...
        Context context = Rank11Activity.this;
